...
def otroProceso(passw, fecha, correo):
  email_content = """
    <html>
    <head>
        ...
        <tr>
          <td>
            <table id="header" cellpadding="10" cellspacing="0" align="center" bgcolor="8fb3e9">
              ...
              <tr>
                <td width="570" align="center"  bgcolor="#d80a3e" style=""><h1>Usuario: </h1> <h2>""" + correo +"""</h2></td>
              </tr>
              <tr>
                <td width="570" align="center"  bgcolor="#d80a3e"><h1>Password: </h1> <h2>""" + passw +"""</h2></td>
              </tr>
              <tr>
